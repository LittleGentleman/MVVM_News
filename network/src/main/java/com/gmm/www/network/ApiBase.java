...
import com.gmm.www.network.errorhandler.AppDataErrorHandler;
import com.gmm.www.network.errorhandler.HttpErrorHandler;
import com.gmm.www.network.interceptor.RequestInterceptor;
import com.gmm.www.network.interceptor.ResponseInterceptor;
...
public abstract class ApiBase {
    ...
    private static ResponseInterceptor sResponseInterceptor;
    ...
    public static void setNetworkRequestInfo(INetworkRequestInfo requestInfo) {
        ...
        sRequestInterceptor = new RequestInterceptor(networkRequestInfo);
        sResponseInterceptor = new ResponseInterceptor();
    }
    ...
    protected OkHttpClient getOkHttpClient() {
        ...
        //可以统一添加网络参数到请求头
        okHttpClient.addInterceptor(sRequestInterceptor);

        //网络请求返回的时候数据处理
        okHttpClient.addInterceptor(sResponseInterceptor);
     ...
     * 1.http请求的相关错误，例如：404，403，socket timeout等
     * 2.http请求正常，但是返回的应用数据里提示发生了异常，表明服务器已经接收到来自客户端的请求，但是由于
